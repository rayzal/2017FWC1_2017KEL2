...
<div class="wrapper">
 ...
 -->
            <img src="{{ asset('AdminLTE-2.3.7/dist/img/user4-128x128.jpg') }}" alt="user image" class="online">
                <p class="message">
                  <a href="#" class="name">
              ...
              <div class="item">
               ...
               <img src="{{ asset('AdminLTE-2.3.7/dist/img/user3-128x128.jpg') }}" alt="user image" class="offline">
             ...
             <img src="{{ asset('AdminLTE-2.3.7/dist/img/user2-160x160.jpg') }}" alt="user image" class="offline">
...
<!-- Bootstrap 3.3.6 -->
<!-- jQuery 2.1.4 -->
<script src="{{ asset('AdminLTE-2.3.7/plugins/jQuery/jQuery-2.1.4.min.js') }}"></script>
<!-- jQuery UI 1.11.4 -->
<script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
...
<script src="{{ asset('AdminLTE-2.3.7/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- jQuery Knob Chart -->
...
<script src="{{ asset('AdminLTE-2.3.7/dist/js/pages/dashboard.js') }}"></script>

              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('AdminLTE-2.3.7/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('AdminLTE-2.3.7/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url('tamu')}}"><i class="fa fa-circle-o"></i> Tamu</a></li>
            <li><a href="{{url('kamar')}}"><i class="fa fa-circle-o"></i> Kamar</a></li>
            <li><a href="{{url('harga')}}"><i class="fa fa-circle-o"></i> Harga</a></li>
            <li><a href="{{url('transaksi')}}"><i class="fa fa-circle-o"></i> Transaksi</a></li>
            <li><a href="{{url('check_in')}}"><i class="fa fa-circle-o"></i> CheckIn</a></li>
            <li><a href="{{url('check_out')}}"><i class="fa fa-circle-o"></i> CheckOut</a></li>
            <li><a href="{{url('fasilitas')}}"><i class="fa fa-circle-o"></i> Fasilitas</a></li>
            <li><a href="{{url('fasilitas_kamar')}}"><i class="fa fa-circle-o"></i> Fasilitas Kamar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

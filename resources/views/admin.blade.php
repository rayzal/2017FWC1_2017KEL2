...
<head>
  ...
  <title>Admin| Paragon Hotel</title>
...
<body class="hold-transition skin-purple sidebar-mini">
              ...
              <ul class="dropdown-menu">
                ...
                <!-- <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="{{ url('index') }}" class="btn btn-default btn-flat">Logout</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu">
          ...
          <!-- <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> VIP</a></li>
              <li><a href="index2.html"><i class="fa fa-circle-o"></i> Ekonomi</a></li>
            </ul>
          </li> -->
        <!-- <li class="treeview">
          <a href="#">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 Edited By Kelompok 2 C1 2015</strong> All rights
    reserved.
  </footer>
